...
const fields: Array<[string, string, string]> = [["policy.insurer", "Aseguradora", "insurer"], ["policy.policyNumber", "Número de póliza", "policyNumber"], ["policy.validFrom", "Vigencia desde", "validFrom"], ["policy.validUntil", "Vigencia hasta", "validUntil"], ["user.name", "Asegurado", "overall"], ["address.city", "Ciudad / municipio", "address"], ["address.state", "Entidad federativa", "address"], ["vehicle.make", "Marca", "vehicle"], ["vehicle.model", "Modelo", "vehicle"], ["vehicle.version", "Versión", "vehicle"], ["vehicle.year", "Año", "vehicle"], ["vehicle.plate", "Placas", "vehicle"], ["vehicle.vin", "VIN", "vehicle"], ["vehicle.engine", "Motor", "vehicle"], ["vehicle.color", "Color", "vehicle"], ["vehicle.fuelType", "Combustible", "vehicle"], ["verification.stickerColor", "Color de engomado", "verification"], ["verification.regime", "Régimen de verificación", "verification"], ["policy.assistancePhone", "Asistencia", "overall"], ["policy.claimsPhone", "Siniestros", "overall"]];
...
function displayValue(path: string, value: string) {
  return path === "verification.stickerColor" ? verificationLabels[value] ?? value : value;
}
